...
//---------- LINK
const _loadLinkAction = actionBuilder({names: ['personLink'], type:'load', service: personServices.loadPerson});
export const loadLinkTypes = _loadLinkAction.types;
export const loadLinkAction = _loadLinkAction.action;
